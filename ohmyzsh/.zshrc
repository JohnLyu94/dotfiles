...
# NeoVim Setting Configuration
export VIMCONFIG=~/.config/nvim
export VIMDATA=~/.local/share/nvim

source $VIMCONFIG/nvim-aliases.sh

# SQLite3 and OpenSSL 1.1 and clang
#export PATH="/opt/homebrew/opt/sqlite/bin:/opt/homebrew/opt/openssl@3/bin:$PATH"
